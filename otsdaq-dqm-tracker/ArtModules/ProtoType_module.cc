...
// Trigger/srs/ots::ProtoType. Much of the code was copied over from that module
// but has been adapted for Online vicualization.
...
void ots::ProtoType::endJob() { TLOG(TLVL_INFO) << "Completed"; }
