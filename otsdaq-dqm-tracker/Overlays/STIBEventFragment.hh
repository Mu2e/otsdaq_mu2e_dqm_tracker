...
public:
  ...
  static_assert(sizeof(Data) <= sizeof(uint32_t),
                "STIBEventFragment::Data too large!");
  static_assert(sizeof(Data) >= sizeof(uint32_t),
                "STIBEventFragment::Data too small!");
  ...
  Header::counter_t hdr_system_status() const {
    return header_()->system_status;
  }
  bool hdr_system_status_fifo_full() const {
    return header_()->system_status & 0x1;
  }
  bool hdr_system_status_clock_lock() const {
    return header_()->system_status & 0x2;
  }
