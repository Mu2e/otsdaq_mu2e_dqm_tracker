...
uint32_t DataDecoder::convertBuffer(const std::string &buffer,
                                    unsigned int bufferIndex, bool invert) {
  if (invert)
...
//========================================================================================================================
uint64_t DataDecoder::mergeBCOHighAndLow(uint32_t dataBCOHigh,
                                         uint32_t dataBCOLow) {
  return bcoDataDecoder_.mergeBCOHighAndLow(
      bcoDataDecoder_.decodeBCOHigh(dataBCOHigh),
