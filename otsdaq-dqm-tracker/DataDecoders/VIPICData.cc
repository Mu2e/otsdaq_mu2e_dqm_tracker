...
VIPICData &VIPICData::decode(uint32_t word) {
  ...
  // 					std::cout << __COUT_HDR_FL__ << "BCO = " << hex <<
  // bco_counter << dec
  // <<
  // "
  // ("
  // << bco_counter-last_bco << ")" << std::endl; 					if (
  // bco_counter -
  // last_bco > 256 ) { 						nhit =
  // 0;
  // 					}
  ...
  // 					std::cout << __COUT_HDR_FL__ << "Trigger low = " <<
  // trignum_low <<
  // ", bco
  // =
  // "
  ...
  // 					std::cout << __COUT_HDR_FL__ << "Trigger high = " <<
  // trignum_high
  // << std::endl; 					break;
  // 				}
  // 				case 0x0c:
  ...
  // 					int bco = (word>>8)&0xff;
  // 					std::cout << __COUT_HDR_FL__ << "Trigger word " <<
  // 15-datatype <<
  // "
  // :
  // "
  // << std::endl; 					for ( int k=7; k>=0; k-- )
  // { 						if ( (trig1&(1<<k)) ) { 							std::cout << __COUT_HDR_FL__ << "#" << std::endl;
  // 						}
  // 						else {
  // 							std::cout << __COUT_HDR_FL__ << "_" <<
  // std::endl;
  // 						}
  // 					}
  // 					std::cout << __COUT_HDR_FL__ << "  " <<
  // std::endl; 					for ( int k=7; k>=0; k-- ) { 						if ( (trig0&(1<<k)) ) { 							std::cout
  // << __COUT_HDR_FL__ << "#" << std::endl;
  // 						}
  // 						else {
  // 							std::cout << __COUT_HDR_FL__ << "_" <<
  // std::endl;
  ...
  //        << chipid_ << " set: " << set_ << " strip: " << strip_ << " adc: "
  //        << adc_ << " bco: " << hex << bco << dec << " istrip: " << istrip_
  //        << std::endl; if ( chan > 6 || istrip > 639 ) {
  //          std::cout << __COUT_HDR_FL__ << "Bad word " << i << " = " << hex
  //          << word
  //          << dec << " = " << chan << "," << chipid << "," << set << "," <<
  //          strip << " = " << istrip << std::endl;
  //        }
  //        nhit += 1;
  //      }
  //      else if ( type == 2 ) {
  ...
  //        int bco = (word>>8)&0xff;
  //        std::cout << __COUT_HDR_FL__ << hex << setw(8) << setfill('0') <<
  //        word << dec << "   VIPIC pixel " << pix << " count = " << count <<
  //        ", bco = " << hex
  //        << bco << dec << std::endl;
  //      }
  //      else if ( type == 10 ) {
  ...
  //        int bco = (word>>8)&0xff;
  //        std::cout << __COUT_HDR_FL__ << hex << setw(8) << setfill('0') <<
  //        word << dec << "  PSI46 channel " << chan << " count = " << count <<
  //        ", bco = " << hex << bco << dec << std::endl;
  //      }
  //      else if ( type == 6 ) {
  //        int adc = (word>>8)&0xff;
  ...
  //        int col = (word>>22)&0xf;
  //        std::cout << __COUT_HDR_FL__ << hex << setw(8) << setfill('0') <<
  //        word << dec << "  PSI46 hit col " << col << " row " << row << ", adc
  //        = " << adc << std::endl;
  //      }

  // std::cout << __COUT_HDR_FL__ << __PRETTY_FUNCTION__ << " Chan: " << chan <<
  // " chipId: " << (int)chipId_
  //    << " set: " << (unsigned int)set_ << " strip: " << (int)stripNumber_ <<
  //    " bco: "
  //    << (int)bco_ << std::endl;
}
...
//========================================================================================================================
unsigned int VIPICData::getChannelNumber(void) {
  return (unsigned int)channelNumber_;
}
...
//========================================================================================================================
unsigned int VIPICData::getStripNumber(void) {
  return (unsigned int)stripNumber_;
}
